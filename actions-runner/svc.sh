...
SVC_NAME="actions.runner.tombo0-node-express-rest-api-example.pop-os.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (tombo0-node-express-rest-api-example.pop-os)"
